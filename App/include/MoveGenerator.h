...
public:
	...
	checkers_types::bitboard GetMovementsForPawn(size_t i, Sides side) const noexcept;
	checkers_types::bitboard GetCapturesForPawns(Sides side, checkers_types::bitboard allies, checkers_types::bitboard enemies, checkers_types::bitboard pawns) noexcept;
	checkers_types::bitboard GetCapturesForPawn (Sides side, checkers_types::bitboard allies, checkers_types::bitboard enemies, size_t i) noexcept;
...
private:
	...
	size_t GetFirstBlockerIndex(checkers_types::bitboard board, bool is_above) const noexcept;
